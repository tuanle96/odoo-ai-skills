...
# --- 4. Auto-trigger surface (code that fires WITHOUT a user clicking) --------
triggers = {
...
# --- 6. Recommended manifest depends (so an override lands at the right layer)
# A new custom module must depend on the standard modules in a method's chain,
# otherwise the override sits at the wrong MRO position. Depending on the
# highest-level one usually pulls the rest transitively.
chain_addons = []
